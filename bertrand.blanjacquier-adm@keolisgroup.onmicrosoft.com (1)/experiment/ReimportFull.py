...
display(spark.sql("DROP TABLE IF EXISTS VALIDATIONSTATUS"))

# COMMAND ----------

#display(spark.sql("DROP TABLE IF EXISTS FACT_VALIDATION"))
...
dbutils.fs.ls("/mnt/curated/TransCity-DWH/")
...
TableKey = "VALIDATIONID"
PartitionBy = "VALIDATIONDATEID"
...
#Read new data
newData = spark.read.parquet(f"mnt/raw/{Source}/{Object}/2022/02/10/{Object}*.parquet")
